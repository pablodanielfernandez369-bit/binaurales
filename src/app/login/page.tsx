  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center p-6 bg-[#0A0E1A]">
      ...
      >
        ...
        <div className="bg-[#4B2C69]/10 border border-white/10 rounded-[32px] p-8 backdrop-blur-xl shadow-2xl">
              ...
              >
                ...
                {status === 'error' && (
                  <motion.div 
                    ...
                    className="flex items-center gap-3 text-red-400 bg-red-400/5 p-4 rounded-2xl border border-red-400/10 text-xs"
                  >
                    <AlertCircle size={16} />
                    <p>{message}</p>
                  </motion.div>
